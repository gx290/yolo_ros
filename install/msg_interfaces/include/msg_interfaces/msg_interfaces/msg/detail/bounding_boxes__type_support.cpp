...
{
  new (message_memory) msg_interfaces::msg::BoundingBoxes(_init);
}

void BoundingBoxes_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msg_interfaces::msg::BoundingBoxes *>(message_memory);
  typed_message->~BoundingBoxes();
}

size_t size_function__BoundingBoxes__bounding_boxes(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<msg_interfaces::msg::BoundingBox> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<msg_interfaces::msg::BoundingBox> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<msg_interfaces::msg::BoundingBox> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const msg_interfaces::msg::BoundingBox *>(
    get_const_function__BoundingBoxes__bounding_boxes(untyped_member, index));
  auto & value = *reinterpret_cast<msg_interfaces::msg::BoundingBox *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<msg_interfaces::msg::BoundingBox *>(
    get_function__BoundingBoxes__bounding_boxes(untyped_member, index));
  const auto & value = *reinterpret_cast<const msg_interfaces::msg::BoundingBox *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoundingBoxes_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<msg_interfaces::msg::BoundingBox>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(msg_interfaces::msg::BoundingBoxes, bounding_boxes),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BoundingBoxes_message_members = {
  ...
  1,  // number of fields
  sizeof(msg_interfaces::msg::BoundingBoxes),
...
get_message_type_support_handle<msg_interfaces::msg::BoundingBoxes>()
{
  return &::msg_interfaces::msg::rosidl_typesupport_introspection_cpp::BoundingBoxes_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_interfaces, msg, BoundingBoxes)() {
  return &::msg_interfaces::msg::rosidl_typesupport_introspection_cpp::BoundingBoxes_message_type_support_handle;
}
