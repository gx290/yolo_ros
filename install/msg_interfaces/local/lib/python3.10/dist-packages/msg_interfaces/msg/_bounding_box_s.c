...
bool msg_interfaces__msg__bounding_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg_interfaces.msg._bounding_box.BoundingBox", full_classname_dest, 44) == 0);
  }
  msg_interfaces__msg__BoundingBox * ros_message = _ros_message;
  {  // class_id
...
PyObject * msg_interfaces__msg__bounding_box__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg_interfaces.msg._bounding_box");
