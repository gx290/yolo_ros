    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'msg_interfaces.msg.BoundingBoxes')
            logger.debug(
            ...
            from msg_interfaces.msg import BoundingBox
...
class BoundingBoxes(metaclass=Metaclass_BoundingBoxes):
    ...
    _fields_and_field_types = {
        'bounding_boxes': 'sequence<msg_interfaces/BoundingBox>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['msg_interfaces', 'msg'], 'BoundingBox')),  # noqa: E501
    )
