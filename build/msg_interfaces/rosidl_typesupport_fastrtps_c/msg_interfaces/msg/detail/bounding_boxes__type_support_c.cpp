...
#include "msg_interfaces/msg/detail/bounding_boxes__rosidl_typesupport_fastrtps_c.h"
...
#include "msg_interfaces/msg/detail/bounding_box__functions.h"  // bounding_boxes

// forward declare type support functions
size_t get_serialized_size_msg_interfaces__msg__BoundingBox(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_msg_interfaces__msg__BoundingBox(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_interfaces, msg, BoundingBox)();


using _BoundingBoxes__ros_msg_type = msg_interfaces__msg__BoundingBoxes;
  ...
  // Field name: bounding_boxes
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, msg_interfaces, msg, BoundingBox
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: bounding_boxes
  {
    ...
    if (ros_message->bounding_boxes.data) {
      msg_interfaces__msg__BoundingBox__Sequence__fini(&ros_message->bounding_boxes);
    }
    if (!msg_interfaces__msg__BoundingBox__Sequence__init(&ros_message->bounding_boxes, size)) {
...
size_t get_serialized_size_msg_interfaces__msg__BoundingBoxes(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BoundingBoxes__ros_msg_type * ros_message = static_cast<const _BoundingBoxes__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name bounding_boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_msg_interfaces__msg__BoundingBox(
...
static uint32_t _BoundingBoxes__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msg_interfaces__msg__BoundingBoxes(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_interfaces
size_t max_serialized_size_msg_interfaces__msg__BoundingBoxes(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: bounding_boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_msg_interfaces__msg__BoundingBox(
  ...
  if (is_plain) {
    ...
    using DataType = msg_interfaces__msg__BoundingBoxes;
    is_plain =
      (
...
static size_t _BoundingBoxes__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msg_interfaces__msg__BoundingBoxes(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_interfaces, msg, BoundingBoxes)() {
