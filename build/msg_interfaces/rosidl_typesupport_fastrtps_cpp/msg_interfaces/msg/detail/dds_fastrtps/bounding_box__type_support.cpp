...
#include "msg_interfaces/msg/detail/bounding_box__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const msg_interfaces::msg::BoundingBox & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msg_interfaces::msg::BoundingBox & ros_message)
{
  // Member: class_id
  cdr >> ros_message.class_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msg_interfaces::msg::BoundingBox;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msg_interfaces::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msg_interfaces::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  return &msg_interfaces::msg::typesupport_fastrtps_cpp::_BoundingBox__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_interfaces, msg, BoundingBox)() {
  return &msg_interfaces::msg::typesupport_fastrtps_cpp::_BoundingBox__handle;
}
