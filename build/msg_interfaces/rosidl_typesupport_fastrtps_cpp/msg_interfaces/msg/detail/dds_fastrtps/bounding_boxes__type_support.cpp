...
#include "msg_interfaces/msg/detail/bounding_boxes__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const msg_interfaces::msg::BoundingBox &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  msg_interfaces::msg::BoundingBox &);
...
cdr_serialize(
  const msg_interfaces::msg::BoundingBoxes & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: bounding_boxes
  {
    ...
    for (size_t i = 0; i < size; i++) {
      msg_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msg_interfaces::msg::BoundingBoxes & ros_message)
{
  // Member: bounding_boxes
  {
    uint32_t cdrSize;
    ...
    for (size_t i = 0; i < size; i++) {
      msg_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: bounding_boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        msg_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: bounding_boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        msg_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_BoundingBox(
  ...
  if (is_plain) {
    ...
    using DataType = msg_interfaces::msg::BoundingBoxes;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msg_interfaces::msg::BoundingBoxes *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msg_interfaces::msg::BoundingBoxes *>(
    untyped_ros_message);
...
{
  return &msg_interfaces::msg::typesupport_fastrtps_cpp::_BoundingBoxes__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_interfaces, msg, BoundingBoxes)() {
  return &msg_interfaces::msg::typesupport_fastrtps_cpp::_BoundingBoxes__handle;
}
